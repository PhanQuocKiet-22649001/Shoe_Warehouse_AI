...
<div class="employees-container">
    ...
    <div class="employees-header d-flex justify-content-between align-items-center mb-3">
        ...
        <?php if ($_SESSION['role'] === 'MANAGER'): ?>
            <button class="btn btn-add-brand px-4 fw-bold text-dark border border-dark" data-bs-toggle="modal" data-bs-target="#addModal">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($user['user_id'] == $_SESSION['user_id']): ?>
                                <a href="index.php?page=profile" class="btn-profile" style="text-decoration: none; color: black;">
                                    Cập nhật thông tin
                                </a>
                            <?php else: ?>
                                <?php if ($_SESSION['role'] === 'MANAGER'): ?>
