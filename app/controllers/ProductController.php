...
//         $shelvesList = $this->productModel->getAllShelves();
...
//     {
//         $rawShelves = $this->productModel->getAllShelves();
//         $brandMap = $this->productModel->getVariantBrandMap();
...
//         $variants = $this->productModel->searchVariantsRaw($keyword);
