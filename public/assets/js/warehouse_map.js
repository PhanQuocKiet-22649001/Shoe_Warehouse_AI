...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (mapCollapseArea && mapToggleIcon) {
        mapCollapseArea.addEventListener('show.bs.collapse', function () {
            ...
            btnToggleMap.querySelector('span').innerHTML = '<i class="fas fa-eye-slash me-2"></i> ĐÓNG SƠ ĐỒ KHO';
        });
        ...
        mapCollapseArea.addEventListener('hide.bs.collapse', function () {
            ...
            btnToggleMap.querySelector('span').innerHTML = '<i class="fas fa-map-marked-alt text-dark me-2"></i> BẤM ĐỂ HIỂN THỊ SƠ ĐỒ KHÔNG GIAN KHO';
        });
    }
